...
class Demon(room: RoomState, pos: Tile, id: Int): Enemy(room, pos, 9.5, "demon", id) {

    override val sprite: TextureRegion = TextureRegion(Textures.get("demon"))
    override val bounceHeight: Double = 6.0
    override val maxMoves: Int = 7

    var attackDirection: Direction? = null
    var fireball: DemonFireball? = null
