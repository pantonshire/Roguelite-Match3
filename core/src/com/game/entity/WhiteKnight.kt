...
class WhiteKnight(room: RoomState, pos: Tile, id: Int): Enemy(room, pos, 2.0, "whiteknight", id) {

    override val sprite: TextureRegion = TextureRegion(Textures.get("white_knight"))
    override val bounceHeight: Double = 5.0
    override val maxMoves: Int
        get() = if(willCharge) 20 else 5
